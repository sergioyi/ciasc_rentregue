...
<body>
    ...
    <strong><span class="ciasc">C . I . A . S . C</span></strong>
      <form action = "arquivosJSP/processaDadosAdmin.jsp"  method="post">
      <div id="seprar-inputs"><!--corpo que sepra no space-beetwenn dos botões--->
      <div>
        <div class="caixa-tipo">
    <input type="hidden" name="id" class="input">
    <label for="Tipo" class="texto">Tipo: <label><br>
    <input type="number" name="tipo" class="input">
    </div>
