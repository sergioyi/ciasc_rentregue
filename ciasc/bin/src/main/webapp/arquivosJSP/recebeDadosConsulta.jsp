...
<%
    ...
    try {
        ...
        conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/ciasc_01?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC", "root", "97685712");
    ...
    if (!consultas.isEmpty()) {
        ...
        htmlResultado.append("<th>CPF</th>");
        ...
        htmlResultado.append("<p>Nenhum resultado encontrado.</p>");
    }
