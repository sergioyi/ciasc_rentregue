	...
	<div class="centralizar">
		<main>
			...
			<form action="arquivosJSP/processaDadosConsulta.jsp" method="post">
				...
				<div class="linha1">
					<!--aqui Ã© para deixar o "nome" ao lado do "email" -->
					<div id="caixa-nome">
					...
					<div id="caixa-email">
						<label for="email" class="e-mail">E-mail</label><br> <input
				...
				<!--fim da linha 1-->
				<div class="linha2">
					<!--aqui Ã© para deixar os 3 inputs juntos-->
					<!-- - 
      <div id="caixa-nascimento">
        ...
        -->
					...
					<div id="caixa-cpf">
						<label for="cpf" class="cpf">RG</label><br> <input
							type="text" id="cpf" name="cpf" placeholder="1234.567-ES" />
					</div>

					<div id="caixa-telefone">
						<label for="telefone" class="telefone">Telefone</label><br> <input
				...
				<!--fim da linha 2-->
				<div class="linha3">
					<!--aqui Ã© pra colocar os 3 inputs juntos-->

            <div id="caixa-especialidade">
              <label for="especialidade" class="especialidade">Especialidade</label><br>
              <input type="" id="especialidade" name="especialidade" list="op" required />
              <datalist id="op">
              <option>Enfermagem</option>
              <option>Fisioterapia</option>
              <option>Nutrição</option>
                  <!--aqui fica as opçoes de especialidades-->
                </datalist>
              </div>
            ...
            <div id="caixa-hora">
              ...
              <input type="text" id="hora" name="hora" list="op2" required/>
              <datalist id="op2">
                <!--aqui fica as opçoes de especialidades-->
              </datalist>  
            </div>
				...
				<button class="botao" type="submit" id="botao">
...
function horarioNutri(){
  let valor = especialidade.value;
  if(valor == "Nutrição"){
const op = document.getElementById("op2");
